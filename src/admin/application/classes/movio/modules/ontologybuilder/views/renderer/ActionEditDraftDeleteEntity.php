...
class movio_modules_ontologybuilder_views_renderer_ActionEditDraftDeleteEntity extends GlizyObject
{
    function renderCell( $key, $value, $row )
	{
        ...
        $output .= __Link::makeLinkWithIcon('actionEntities', 'btn-icon icon-edit', array('title' => __T('GLZ_RECORD_EDIT_DRAFT'), 'entityTypeId' => $entityTypeId, 'entityId' => $entityId, 'action' => 'editDraft' ) );
