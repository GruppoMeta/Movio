...
// modify by Daniele Ugoletti for Glizy Framework

if ( !window.SeadragonConfig ) {
	window.SeadragonConfig = {};
	SeadragonConfig.imgPath = '';
}
...
Seadragon.NavControl.prototype = {
    ...
    _onFullPage: function() {
		...
		if ( this._viewer.onFullPage )
		{
			this._viewer.onFullPage.apply( this._viewer );
		}
    }
}
...
Seadragon.Strings = {
    Errors: {
        Failure: SeadragonConfig.Failure ? SeadragonConfig.Failure : "Sorry, but Seadragon Ajax can't run on your browser!\n" + "Please try using IE 7 or Firefox 3.\n",
        Dzc:  SeadragonConfig.Dzc ? SeadragonConfig.Dzc : "Sorry, we don't support Deep Zoom Collections!",
        Dzi:  SeadragonConfig.Dzi ? SeadragonConfig.Dzi : "Hmm, this doesn't appear to be a valid Deep Zoom Image.",
        Xml:  SeadragonConfig.Xml ? SeadragonConfig.Xml : "Hmm, this doesn't appear to be a valid Deep Zoom Image.",
        Empty:  SeadragonConfig.Empty ? SeadragonConfig.Empty : "You asked us to open nothing, so we did just that.",
        ImageFormat:  SeadragonConfig.ImageFormat ? SeadragonConfig.ImageFormat : "Sorry, we don't support {0}-based Deep Zoom Images.",
        Security:  SeadragonConfig.Security ? SeadragonConfig.Security : "It looks like a security restriction stopped us from " + "loading this Deep Zoom Image.",
        Status:  SeadragonConfig.Status ? SeadragonConfig.Status : "This space unintentionally left blank ({0} {1}).",
        Unknown:  SeadragonConfig.Unknown ? SeadragonConfig.Unknown : "Whoops, something inexplicably went wrong. Sorry!"
    },

    Messages: {
        Loading: SeadragonConfig.Loading ? SeadragonConfig.Loading : "Loading..."
    },

    Tooltips: {
        FullPage: SeadragonConfig.FullPage ? SeadragonConfig.FullPage : "Exit",
        Home: SeadragonConfig.Home ? SeadragonConfig.Home : "Fit image",
        ZoomIn: SeadragonConfig.ZoomIn ? SeadragonConfig.ZoomIn : "Zoom in",
        ZoomOut: SeadragonConfig.ZoomOut ? SeadragonConfig.ZoomOut : "Zoom out"
    },
...
Seadragon.Config = function () {
    ...
    this.navImages = {
        zoomIn: {
            REST: SeadragonConfig.imgPath + 'OpenSeadragon/images/zoomin_rest.png',
            GROUP: SeadragonConfig.imgPath + 'OpenSeadragon/images/zoomin_grouphover.png',
            HOVER: SeadragonConfig.imgPath + 'OpenSeadragon/images/zoomin_hover.png',
            DOWN: SeadragonConfig.imgPath + 'OpenSeadragon/images/zoomin_pressed.png'
        },
        zoomOut: {
            REST: SeadragonConfig.imgPath + 'OpenSeadragon/images/zoomout_rest.png',
            GROUP: SeadragonConfig.imgPath + 'OpenSeadragon/images/zoomout_grouphover.png',
            HOVER: SeadragonConfig.imgPath + 'OpenSeadragon/images/zoomout_hover.png',
            DOWN: SeadragonConfig.imgPath + 'OpenSeadragon/images/zoomout_pressed.png'
        },
        home: {
            REST: SeadragonConfig.imgPath + 'OpenSeadragon/images/home_rest.png',
            GROUP: SeadragonConfig.imgPath + 'OpenSeadragon/images/home_grouphover.png',
            HOVER: SeadragonConfig.imgPath + 'OpenSeadragon/images/home_hover.png',
            DOWN: SeadragonConfig.imgPath + 'OpenSeadragon/images/home_pressed.png'
        },
        fullpage: {
            REST: SeadragonConfig.imgPath + 'OpenSeadragon/images/fullpage_rest.png',
            GROUP: SeadragonConfig.imgPath + 'OpenSeadragon/images/fullpage_grouphover.png',
            HOVER: SeadragonConfig.imgPath + 'OpenSeadragon/images/fullpage_hover.png',
            DOWN: SeadragonConfig.imgPath + 'OpenSeadragon/images/fullpage_pressed.png'
        }
    }
}
...
Seadragon.Debug = {}
Seadragon.Debug.fail = function(){};
Seadragon.Debug.log = function(){};
Seadragon.Debug.error = function(){};