...
{
    /** @var org_glizy_mvc_components_State $controller */
	protected $controller = NULL;
	/** @var org_glizy_mvc_components_State $view */
	protected $view = NULL;
	...
	function setComponentsAttribute( $components, $attribute, $state )
	{
		...
		foreach( $components as $v )
		{
			...
			if ( is_object( $c ) )
			{
				$c->setAttribute( $attribute, $state );
			}
		}
	}
}