...
--
-- Host: localhost:3306
-- Generation Time: Dec 15, 2015 at 10:42 PM
...
(1, 1, NULL, '2015-01-01 12:00:00', 1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Amministratore', 'sito', '', 'Istituzione', '', '', '', '', NULL, 0, '', '', '', '', 'admin', '', '2015-01-01', 'M', '', 1, 1, '', '', 0, '', '');
...
--
ALTER TABLE `registry_tbl`
  MODIFY `registry_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
